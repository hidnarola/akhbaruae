...
$route['more_news/(:any)'] = 'news/more_news/$1';
$route['more_news/(:any)/(:any)'] = 'news/more_news/$1/$2';
$route['news/(:any)'] = 'news/detail/$1';
$route['news/comment/(:any)'] = 'news/add_comment/$1'; 
...
$route['admin/comments/(:any)'] = 'admin/comments/index/$1';
